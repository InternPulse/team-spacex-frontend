        ...
        <section className="receivables rounded-lg border mb-12">
          <div className="border-b bg-custom2">
            ...
            <div className="flex gap-1">
              <h2 className="font-bold text-xl">Total Receivable</h2>
              <div className="pt-2">
          ...
          <div className="p-4 bg-white">
            <p className="pb-3">Total Receivables <span>NGN 0.00</span></p> 
        ...
        <section className="sales-expenses w-full border rounded-lg p-4">
          <div className="border-b py-3 bg-custom2">
            <div className="flex justify-between items-center">
              ...
              <div>
                <select name="" id="" className="border-0 outline-0 bg-custom2 pr-4 flex items-center">
          ...
          <div className="w-full">
            ...
            <p>* Sales value displayed is inclusive of tax and inclusive of credits.</p>
          </div>
        </section>
        <section>
            ...
            {headerGroups.map((headerGroup, i) => (
              <tr {...headerGroup.getHeaderGroupProps()} key={`headerGroup-${i}`}>
                {headerGroup.headers.map((column, j) => (
                  <th {...column.getHeaderProps()} key={`header-${j}`}>{column.render('Header')}</th>
                ))}
              </tr>
            ))}
          </thead>
              ...
              return (
                <tr {...row.getRowProps()} key={`row-${k}`}>
                  {row.cells.map((cell, l) => {
                    return <td {...cell.getCellProps()} key={`cell-${l}`}>{cell.render('Cell')}</td>;
                  })}
                </tr>
              );
            })}
